...
-- -----------------------------------------------------
-- Table `db_projetoX`.`tb_dificuldade`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db_projetoX`.`tb_dificuldade` ;

CREATE TABLE IF NOT EXISTS `db_projetoX`.`tb_dificuldade` (
  `cd_dificuldade` INT NOT NULL AUTO_INCREMENT,
  `gr_dificuldade` TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_projetoX`.`tb_pergunta` (
  ...
  INDEX `fk_tb_pergunta_tb_dificuldade1_idx` (`id_dificuldade` ASC) ,
  ...
  CONSTRAINT `fk_tb_pergunta_tb_alternativa1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_pergunta_tb_dificuldade1`
    FOREIGN KEY (`id_dificuldade`)
    REFERENCES `db_projetoX`.`tb_dificuldade` (`cd_dificuldade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_projetoX`.`tb_pergunta_submateria`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db_projetoX`.`tb_pergunta_submateria` ;

CREATE TABLE IF NOT EXISTS `db_projetoX`.`tb_pergunta_submateria` (
  `id_pergunta` INT NOT NULL,
  `id_submateria` INT NOT NULL,
  PRIMARY KEY (`id_pergunta`, `id_submateria`),
  INDEX `fk_tb_pergunta_has_tb_submateria_tb_submateria1_idx` (`id_submateria` ASC) ,
  INDEX `fk_tb_pergunta_has_tb_submateria_tb_pergunta1_idx` (`id_pergunta` ASC) ,
  CONSTRAINT `fk_tb_pergunta_has_tb_submateria_tb_pergunta1`
    FOREIGN KEY (`id_pergunta`)
    REFERENCES `db_projetoX`.`tb_pergunta` (`cd_pergunta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_pergunta_has_tb_submateria_tb_submateria1`
